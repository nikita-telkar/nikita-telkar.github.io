...
> Driven to leverage my inter-disciplinary scientific training towards bio-entrepreneurship and equitable healthcare.   
>  
...
I'm a PhD Candidate in the [Medical Genetics Graduate Program](https://medgen.med.ubc.ca/) at [The University of British Columbia](https://ubc.ca/) based in Vancouver, Canada (currently in Boston on an internship).

Motivated by wanting to understand the interconnectedness of differing genomic disciplines, my [research projects](https://nikitatelkar.com/projects.html) have purposefully spanned different scientific domains, driven by ultimately wanting to contribute towards precision-medicine efforts.  
...
I enjoy listening to Jazz, reading Greek mythology, and I like to treat everything new as an adventure (the most recent was trying to play pickleball).  

<br>
<a href = "mailto:nikita.telkar3@gmail.com"><i class="fas fa-envelope"></i></a> | <a href = "https://www.linkedin.com/in/nikitatelkar/"><i class = "fa fa-linkedin" ></i></a> | <a href = "https://github.com/nikita-telkar"><i class = "fa fa-github" ></i></a> | 
...
- 2nd Prize - [Harvard University GSAS BioVenture Pitch](https://www.linkedin.com/posts/harvard-biotech-club_weve-officially-launched-the-2025-bioventure-activity-7329216572122689536-4Gzi?utm_source=share&utm_medium=member_desktop&rcm=ACoAABtOPKcB6CQqgtktHkcjCTCqk3LhshTuybA)  
...
`Database Usage:` UKB, NCBI, OMIM, GEO, UCSC Genome Browser, ClinVar, GeneCards, UniProt, GTex, RNACentral  
...
##### Awards / Publications / Communications  
...
- **Telkar N**, Hui D, Peñaherrera MS, Yuan V, Martinez VD, Stewart GL, Beristain AG, Lam WL, Robinson WP. (2025). [Profiling the cell-specific small non-coding RNA transcriptome of the human placenta](https://www.nature.com/articles/s41598-025-98939-4). Scientific Reports; 15, 14666  
...
[Foresite Labs](https://foresitelabs.com/), Boston, USA (April 2025 - )  

* Hypothesis- and data-driven patient stratification for priority disease indications at this computational genomics venture incubator  
* Analysis results informing incubator company strategy  
* Proactively engaged with the company to create this position for me  
...
* Established the [pan-Canadian Chapter](https://www.linkedin.com/company/nucleate-canada/) of the largest global pre-seed life sciences non-profit organization  
* Directed the flagship accelerator program (the Activator) it its inaugural cycle Canada-wide  
* Secured sponsorships ($100K+ CAD) with Canada’s and BC’s leading organizations and biotechs  

<br>  


#####  **Investment Associate**     
[Front Row Ventures](https://frontrow.ventures/), British Columbia, Canada (October 2023 - March 2025)  

*  Sourced the most ventures on the BC Investment Team (30), conducted first-round due diligence on 11
(37%), progressed 3 (27%) to Investment Committee, resulting in 1 successful investment (33%).
*  Streamlined the investment-specific training modules undertaken by all trainee associates every year
...
* Annotated 100k+ entities (text, image) for the platform’s foundational machine learning training models   
