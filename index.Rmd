...
> Big fan of `ggplot2` and Jazz music. Jack-of-all-Trades kinda person*  `r fa("palette", fill = "black")`   
...
```{r, echo=FALSE, out.width = "90%", error=FALSE}

knitr::include_graphics(here::here("static", "NT_Profile_round.png"))
