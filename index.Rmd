...
```{r loadings-1, echo=FALSE, include=FALSE, message=FALSE, error=FALSE, warning=FALSE}
...
```{r profile-image, echo=FALSE, out.width = "90%", error=FALSE}

knitr::include_graphics(here::here("static", "NT_Profile_2025_round.png"))
