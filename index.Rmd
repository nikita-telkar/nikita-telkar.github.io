...
```{r test, echo=FALSE, include=FALSE, message=FALSE, error=FALSE, warning=FALSE}
...
> 
> Big fan of `ggplot2` and jazz. Jack-of-all-trades kinda person  `r fa("palette", fill = "black")`   
